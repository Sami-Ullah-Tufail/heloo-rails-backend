...
```
  git clone https://github.com/Sami-Ullah-Tufail/heloo-rails-backend.git
```
  
  You can also clone the front-end project using the following command:

```  
  git clone https://github.com/Sami-Ullah-Tufail/hello-react-front-end.git
```
...
Front-end project [link](https://github.com/Sami-Ullah-Tufail/hello-react-front-end).
